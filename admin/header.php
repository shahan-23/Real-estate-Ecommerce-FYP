...
$pending = $data->getNumRows("SELECT * FROM listing WHERE status = 'Pending'"); 
$userpending = $data->getNumRows("SELECT * FROM users WHERE status = 'pending'"); 
                    ...
                    <div class="sticky-area shadow-xs-1 py-3">
                                ...
                                <div class="d-flex align-items-center d-xl-none">
                                    <div class=" px-3">
                                        <div class="d-flex align-items-center text-heading">
                                            <div class="w-48px">
                                                <img src="images\testimonial-5.jpg" 
                        ...
                        <div class="collapse navbar-collapse bg-white" id="primaryMenuSidebar">
                            <ul class="list-group list-group-flush w-100">
                                    ...
                                    <ul class="list-group list-group-no-border rounded-lg">
                                        ...
                                        <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                            <a href="properties.php"
                                                ...
                                                <span class="sidebar-item-text">Properties List</span>
                                                <?php if($pending != NULL) {
                                                        ?>
                                                <span class=" ml-auto text-primary fs-15 font-weight-bold"><?php echo $pending; ?> Pending</span>
                                ...
                                <li class="list-group-item pt-6 pb-4">
                                    <h5 class="fs-13 letter-spacing-087 text-muted mb-3 text-uppercase px-3">Users Settings</h5>
                                    <ul class="list-group list-group-no-border rounded-lg">
                                        <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                            <a href="add_user.php"
                                                class="text-heading lh-1 sidebar-link">
                                                <span class="sidebar-item-icon d-inline-block mr-3 fs-20"><i class="fal fa-user-plus"></i></span>
                                        ...
                                        <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                                            <a href="users.php"
                                                class="text-heading lh-1 sidebar-link d-flex align-items-center">
                                                <span class="sidebar-item-icon d-inline-block mr-3 fs-20"><i class="fal fa-users"></i></span>
                                                <span class="sidebar-item-text">Users</span>
                                                <?php if($userpending != NULL) {
                                                        ?>
                                                <span class=" ml-auto text-primary fs-15 font-weight-bold"><?php echo $userpending; ?> Pending</span>
