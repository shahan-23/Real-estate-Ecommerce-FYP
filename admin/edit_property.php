...
if(isset($_POST["save"])){
    ...
    if(empty($_FILES['File']['name'])){
        ...
        SET name = '".$_POST["title"]."', location = '".$_POST["location"]."', type = '".$_POST["category"]."', description = '".$_POST["description"]."' , price = '".$_POST["price"]."', contact = '".$_POST["contact"]."', map_link = '".$_POST["map_link"]."'
        WHERE id ='".$_POST["id"]."'";
      ...
      if($isUpdated) {
        ...
        $updateQuery = "UPDATE Listing 
        SET name = '".$_POST["title"]."', location = '".$_POST["location"]."', image = '".$fileName."', type = '".$_POST["category"]."', description = '".$_POST["description"]."' , price = '".$_POST["price"]."', contact = '".$_POST["contact"]."', map_link = '".$_POST["map_link"]."'
        WHERE id ='".$_POST["id"]."'";
         $isUpdated = $data->setData($updateQuery);	
         if($isUpdated) {
            $Message = "Details Updated.";
