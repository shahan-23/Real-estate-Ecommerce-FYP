        ...
        <div class="slick-slider mx-0 custom-arrow-center"
            ...
            <div class="box px-0 d-flex flex-column">
                <div class="bg-cover d-flex align-items-center custom-vh-02"
                    style="background-image: url('images/dhaka.jpg')">
                </div>
            </div>
            <div class="box px-0 d-flex flex-column">
                <div class="bg-cover d-flex align-items-center custom-vh-02"
                    style="background-image: url('images/dhaka2.jpg')">
                </div>
            </div>
            <div class="box px-0 d-flex flex-column">
                <div class="bg-cover d-flex align-items-center custom-vh-02"
                    style="background-image: url('images/dhaka3.jpg')">
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div class="col-lg-9">
                                <div class="position-relative w-100">
                                    ...
                                    <input type="text" class="form-control form-control-lg border-0 shadow-none rounded-left-md-0 rounded-right-md-0 pr-8 bg-white placeholder-muted"
                                        placeholder="Enter name or location" name="search">
                                </div>
                            </div>
...
<!-- 
          <section>
            <div class="slick-slider mx-0 custom-arrow-center"
                data-slick-options='{"slidesToShow": 1, "infinite": true, "autoplay":true,"responsive":[{"breakpoint": 1200,"settings": {"slidesToShow":1,"arrows":false,"dots":false}},{"breakpoint": 992,"settings": {"slidesToShow":1,"arrows":false,"dots":false}},{"breakpoint": 768,"settings": {"slidesToShow": 1,"arrows":false,"dots":false}},{"breakpoint": 576,"settings": {"slidesToShow": 1,"arrows":false,"dots":false}}]}'>
                <div class="box px-0 d-flex flex-column">
                    <div class="bg-cover d-flex align-items-center custom-vh-02"
                ...
                <div class="box pb-7 pt-2">
                    <div class="card shadow-hover-2">
                        ...
                        <div class="card-body pt-3">
                            ...
                            <button type="submit" style="border: none; background: none; padding: 0;" class="text-dark hover-primary"><?php echo $row['name'] ?></button>
                            </form>
                            </h2>
                                ...
                                <li class="list-inline-item">
                                    <form action="" method="post">
                                      <input type="hidden" name="pid" value="<?php echo $row['id'] ?>">
                                         <button type="submit" name="fav" style="border: none; background: none; padding: 0;" class="w-40px h-40 border rounded-circle d-inline-flex align-items-center justify-content-center text-secondary bg-accent border-accent" data-toggle="tooltip" title="Wishlist"><i class="fas fa-heart"></i></button>
                                    </form>
                                </li>
        ...
        <div class="container">
            <div class="card border-0 mt-n13 z-index-3 pb-8 pt-10">
                <div class="card-body p-0">
                    <h2 class="text-heading mb-2 fs-22 fs-md-32 text-center lh-16">Leave any feedback!

                        </h2>
                        <p class="mxw-751 text-center mb-1 px-8">Contact us: bananiproperty-bd@gmail.com</p>
                    ...
                    <div class="col-sm-6 col-lg-4 mb-6 mb-lg-0">
                        <div class="card bg-transparent border-0 shadow-2 px-7 py-5 h-100 shadow-hover-lg-1">
                            ...
                            <div class="card-body px-0 pt-3 pb-0">
                                ...
                                <div class="d-block text-body hover-primary text-decoration-none">Golden Plaza, (3rd Floor)Plot No. 34, Road No. 46, Gulshan Circle-2, Dhaka-1212.</div>
                            </div>
                        </div>
                    </div>
                </div>
