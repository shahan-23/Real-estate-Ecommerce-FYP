...
if(isset($_POST['remove'])){
    $data->setData("DELETE FROM fav WHERE user_id ='".$_POST["user"]."' AND pid ='".$_POST["pid"]."'");
      ...
      $favs = $data->getData("SELECT * FROM fav LEFT JOIN listing ON fav.pid = listing.id WHERE fav.user_id ='".$_SESSION["SellerUserid"]."' ");
                                    ...
                                    <div
                                        ...
                                        <ul class="list-inline mb-0">
                                            ...
                                            <form action="" method="post">
                                              <input type="hidden" name="user" value="<?php echo $_SESSION["SellerUserid"] ?>">
