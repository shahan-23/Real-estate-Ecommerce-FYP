<?php 
	...
	if (isset($_POST['delete'])) {
		...
		$removesql = "DELETE FROM users WHERE usersName ='$usname'";
		mysqli_query($conn,$removesql);

		session_start();
		session_unset();
		session_destroy();
		header("location: ../index.php?notice=AccountDeleted");
		exit();
...
<body>
	...
	<div class="container">
		...
		<div id="about">
			<h2>Deleting Following Account:</h2>
			<div class="content">
				<div class="text">
					<h3>Account ID:</h3>
					...
					<p>To confirm, click 'Delete Account' button.</p>
						
					<input style="width: 35%; margin-top: 10px; color: #ff0000" type="submit" value="Delete Account" name="delete"><br><br><br>
